...
vim.keymap.set('n', 'fw', require('telescope.builtin').live_grep, { desc = '[S]earch by [G]rep' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'haskell', 'json', 'yaml', 'ocaml' },
